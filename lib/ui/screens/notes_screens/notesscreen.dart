...
class NotesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final selectionNotifier = ref.read(selectionProvider.notifier); //Access to methods to manipulate selected notes list
    final authState = ref.watch(authStateProvider); //Authentication state
    final authNotifier = ref.read(authStateProvider.notifier); //Methods to manipukate authentication state
                ...
                title: Row(
                  ...
                  children: [ 
                    ...
                    label: Text('${selectedNotes.length} selected',
                        style: Styles.w500texts(fontSize: 20.0, color: colorScheme.onSurface)),
                  ),
                  IconButton(
                    onPressed: (){},
                            ...
                            return Center(
                              ...
                              children: [
                                ...
                                Text('No notes yet!\nCreate one.',
                                    ...
                                    style:
                                        Styles.universalFont(fontSize: 20.0)),
                              ],
                            ));
                          }
                          //Display notes
